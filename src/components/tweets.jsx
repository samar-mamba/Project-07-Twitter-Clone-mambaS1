...
function Tweets() {
  return (
    <div className='tweets'>
      ...
      <Tweet tweetProfile={tweetprofil} title="The New York Times" image={tweetimage} value="@nytimes . 2h " text="Gardening boomed during the pandemic. Six Black writers share how it has helped them re-establish, and reimagine, a connection to cultivation and the land"
      />
